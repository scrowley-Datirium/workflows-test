...
- The **workflows** directory is the home for all of the CWL files that make up distinct analyses that can be performed. Workflows will often use **tools** for running individual steps.
